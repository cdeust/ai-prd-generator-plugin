...
| **January 2026** | Packaging as a Claude Code Skill plugin ([ai-prd-generator](https://github.com/cdeust/ai-prd-generator)). Internal testing with positive feedback. Landing page and pilot program launch. |
